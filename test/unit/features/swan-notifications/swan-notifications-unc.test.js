...
} from '../../../../event-libs/v1/features/swan-notifications/swan-notifications-unc.js';
...
// Mode selection (which of feds/unc/off applies) is the router's job — see
// swan-notifications.test.js. These tests exercise this module's own rule-registration
// machinery directly, as the router calls it once unc mode is already selected.
describe('swan-notifications-unc', () => {

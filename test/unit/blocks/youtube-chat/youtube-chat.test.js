...
// Runs the full behavior suite against a given youtube-chat.js implementation
// - the classic block and the C2 copy - so a regression in either is caught
// directly instead of relying on the other variant's coverage.
function runYouTubeChatSuite(modulePath, variantLabel) {
  describe(`YouTube Chat Module (${variantLabel})`, () => {
    let sandbox;
...
runYouTubeChatSuite('../../../../event-libs/v1/blocks/youtube-chat/youtube-chat.js', 'classic');
runYouTubeChatSuite('../../../../event-libs/v1/c2/blocks/youtube-chat/youtube-chat.js', 'C2');

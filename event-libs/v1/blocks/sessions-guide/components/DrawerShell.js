...
import { buildSessionDetailOverlay } from './SessionDetailOverlay.js';
import { buildFilterPanel } from './FilterPanel.js';
import { setSessionsParam, clearSessionParams } from '../utils/url.js';

export function buildDrawerShell(preact, store) {
  ...
  const SessionDetailOverlay = buildSessionDetailOverlay(preact, store);

...
// keeps advancing. Works in every environment, including production — matching the timing
// framework's own `?timing=`/`?serverTime=` params, which have never been environment-gated.

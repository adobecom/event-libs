...
- **`event-libs/v1/c2/blocks/sessions-guide/sessions-guide.js`** `parseConfig()` (lines
...
- **`event-libs/v1/c2/blocks/sessions-guide/components/FilterPanel.js`**: renders the panel
...
- **`event-libs/v1/c2/blocks/sessions-guide/store/index.js`**: `activeFilters` state
  (`{}` initial), `SET_FILTERS` reducer replaces it wholesale (line 62-63).
- **`event-libs/v1/c2/blocks/sessions-guide/utils/session-filters.js`** `filterSessions()`
...
- `event-libs/v1/c2/blocks/sessions-guide/sessions-guide.js` (`parseConfig()` — config shape)
- `event-libs/v1/c2/blocks/sessions-guide/components/FilterPanel.js` (UI)
- `event-libs/v1/c2/blocks/sessions-guide/utils/session-filters.js` (filtering logic)
- `event-libs/v1/c2/blocks/sessions-guide/store/index.js` (`activeFilters` state shape, if it changes)

    ...
    >
      ...
      <div class="sm-editor__block-fragment-path">
        ...
        <div class="sm-editor__block-fragment-path-row">
          ...
          <a \
            href=${isRelativePath && org && repo ? getFragmentPreviewUrl(org, repo, block.fragmentPath) : undefined} \
            target="_blank" \
      ...
      <${FragmentPathBrowser} \
        ...
        onSelect=${(path) => { updateBlockLocally(block.id, { fragmentPath: path }); setIsBrowserOpen(false); }} \
